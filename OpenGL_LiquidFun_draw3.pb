 ...
 ;     For tmp_fixture_vector_num = 1 To tmp_fixture_vector_size
  ...
  ;      clipboard_str = clipboard_str + Chr(10) +
   ...
   ;   SetClipboardText(clipboard_str)
      ...
      If tmp_fixture_vector_size = 2
        
        clipboard_str = "b2PolygonShape_Create3VertexFixture"
        vertice_str = StrF(tmp_fixture_vector(0)\x, 2) + ", " + StrF(tmp_fixture_vector(0)\y, 2) + ", " + StrF(tmp_fixture_vector(1)\x, 2) + ", " + StrF(tmp_fixture_vector(1)\y, 2) + ", " + StrF(tmp_fixture_vector(2)\x, 2) + ", " + StrF(tmp_fixture_vector(2)\y, 2)
      EndIf
      
      If tmp_fixture_vector_size = 3
        
        clipboard_str = "b2PolygonShape_Create4VertexFixture"
        vertice_str = StrF(tmp_fixture_vector(0)\x, 2) + ", " + StrF(tmp_fixture_vector(0)\y, 2) + ", " + StrF(tmp_fixture_vector(1)\x, 2) + ", " + StrF(tmp_fixture_vector(1)\y, 2) + ", " + StrF(tmp_fixture_vector(2)\x, 2) + ", " + StrF(tmp_fixture_vector(2)\y, 2) + ", " + StrF(tmp_fixture_vector(3)\x, 2) + ", " + StrF(tmp_fixture_vector(3)\y, 2)
      EndIf
      
      If tmp_fixture_vector_size = 4
        
        clipboard_str = "b2PolygonShape_Create5VertexFixture"
        vertice_str = StrF(tmp_fixture_vector(0)\x, 2) + ", " + StrF(tmp_fixture_vector(0)\y, 2) + ", " + StrF(tmp_fixture_vector(1)\x, 2) + ", " + StrF(tmp_fixture_vector(1)\y, 2) + ", " + StrF(tmp_fixture_vector(2)\x, 2) + ", " + StrF(tmp_fixture_vector(2)\y, 2) + ", " + StrF(tmp_fixture_vector(3)\x, 2) + ", " + StrF(tmp_fixture_vector(3)\y, 2) + ", " + StrF(tmp_fixture_vector(4)\x, 2) + ", " + StrF(tmp_fixture_vector(4)\y, 2)
      EndIf
      
      If tmp_fixture_vector_size = 5
        
        clipboard_str = "b2PolygonShape_Create6VertexFixture"
        vertice_str = StrF(tmp_fixture_vector(0)\x, 2) + ", " + StrF(tmp_fixture_vector(0)\y, 2) + ", " + StrF(tmp_fixture_vector(1)\x, 2) + ", " + StrF(tmp_fixture_vector(1)\y, 2) + ", " + StrF(tmp_fixture_vector(2)\x, 2) + ", " + StrF(tmp_fixture_vector(2)\y, 2) + ", " + StrF(tmp_fixture_vector(3)\x, 2) + ", " + StrF(tmp_fixture_vector(3)\y, 2) + ", " + StrF(tmp_fixture_vector(4)\x, 2) + ", " + StrF(tmp_fixture_vector(4)\y, 2) + ", " + StrF(tmp_fixture_vector(5)\x, 2) + ", " + StrF(tmp_fixture_vector(5)\y, 2)
      EndIf
      
      If tmp_fixture_vector_size = 6
        
        clipboard_str = "b2PolygonShape_Create7VertexFixture"
        vertice_str = StrF(tmp_fixture_vector(0)\x, 2) + ", " + StrF(tmp_fixture_vector(0)\y, 2) + ", " + StrF(tmp_fixture_vector(1)\x, 2) + ", " + StrF(tmp_fixture_vector(1)\y, 2) + ", " + StrF(tmp_fixture_vector(2)\x, 2) + ", " + StrF(tmp_fixture_vector(2)\y, 2) + ", " + StrF(tmp_fixture_vector(3)\x, 2) + ", " + StrF(tmp_fixture_vector(3)\y, 2) + ", " + StrF(tmp_fixture_vector(4)\x, 2) + ", " + StrF(tmp_fixture_vector(4)\y, 2) + ", " + StrF(tmp_fixture_vector(5)\x, 2) + ", " + StrF(tmp_fixture_vector(5)\y, 2) + ", " + StrF(tmp_fixture_vector(6)\x, 2) + ", " + StrF(tmp_fixture_vector(6)\y, 2)
      EndIf
      
      If tmp_fixture_vector_size = 7
        
        clipboard_str = "b2PolygonShape_Create8VertexFixture"
        vertice_str = StrF(tmp_fixture_vector(0)\x, 2) + ", " + StrF(tmp_fixture_vector(0)\y, 2) + ", " + StrF(tmp_fixture_vector(1)\x, 2) + ", " + StrF(tmp_fixture_vector(1)\y, 2) + ", " + StrF(tmp_fixture_vector(2)\x, 2) + ", " + StrF(tmp_fixture_vector(2)\y, 2) + ", " + StrF(tmp_fixture_vector(3)\x, 2) + ", " + StrF(tmp_fixture_vector(3)\y, 2) + ", " + StrF(tmp_fixture_vector(4)\x, 2) + ", " + StrF(tmp_fixture_vector(4)\y, 2) + ", " + StrF(tmp_fixture_vector(5)\x, 2) + ", " + StrF(tmp_fixture_vector(5)\y, 2) + ", " + StrF(tmp_fixture_vector(6)\x, 2) + ", " + StrF(tmp_fixture_vector(6)\y, 2) + ", " + StrF(tmp_fixture_vector(7)\x, 2) + ", " + StrF(tmp_fixture_vector(7)\y, 2)
      EndIf
      
      clipboard_str = clipboard_str + "(tmpbody_fixture, tmpbody, 1, 0.1, 0, 0, 1, 0, 65535, " + vertice_str + ", 0, 0, @tmpbody_texture)"
